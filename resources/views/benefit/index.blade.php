...
<div class="container my-5">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 mb-5 pb-3 border-bottom">
        ...
        {{-- RESTAURADO: El loop de categorías --}}
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (qrModal) {
            qrModal.addEventListener('show.bs.modal', function (event) {
                ...
                // Depuración en consola (F12) para que veas qué está llegando
                console.log("ID:", id, "Proveedor:", proveedor, "Título:", titulo);
                var elProveedor = document.getElementById('modalProveedor');
                var elTitulo = document.getElementById('modalTitulo');
                var elImagen = document.getElementById('modalQrImage');

                if(elProveedor) elProveedor.innerText = proveedor;
                if(elTitulo) elTitulo.innerText = titulo;
                
                if(elImagen) {
                    var qrUrl = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=UADYSPOT-VAL-" + id;
                    elImagen.src = qrUrl;
                }
            });
        }
